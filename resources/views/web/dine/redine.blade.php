        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Create New Dine</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('dine.storeRedine') }}" method="POST">
                        @csrf
                        <div class="mb-2">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-hover align-middle text-center">
                        ...
                        <tbody>
                            ...
                            $clients = App\Models\ReDine::where("manager_id", $parent_id)->orderBy('id','desc')->get();
                            @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dine.editRedine', $client->id) }}"
                                        class="btn btn-sm btn-primary">Edit</a>

                                    <!-- Delete Button: Sends a POST request to delete the agent -->
                                    <form action="{{ route('dine.deleteRedine', $client->id) }}" method="POST"
                                        class="d-inline"
